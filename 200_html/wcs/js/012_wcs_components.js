...
const WCS_MQTT_HEADER_FALLBACK_HTML = [
    ...
    '                        <input id="mqtt-topic-filter-input-received" type="text" class="form-control mqtt-topic-filter-input" data-history-type="received" placeholder="토픽 포함 문자열 입력">',
    '                    </div>',
    '                </div>',
    ...
    '                        <input id="mqtt-topic-filter-input-published" type="text" class="form-control mqtt-topic-filter-input" data-history-type="published" placeholder="토픽 포함 문자열 입력">',
    '                    </div>',
    '                </div>',
