...
const WCS_MQTT_HEADER_FALLBACK_HTML = [
    ...
    '                                <th class="text-center mqtt-topic-sort-trigger" data-sort-key="time" role="button" tabindex="0" title="시간 정렬">시간 <span class="mqtt-sort-indicator"><span class="mqtt-sort-arrow mqtt-sort-arrow-up">▲</span><span class="mqtt-sort-arrow mqtt-sort-arrow-down">▼</span></span></th>',
    '                                <th class="text-center mqtt-topic-sort-trigger" data-sort-key="topic" role="button" tabindex="0" title="토픽 정렬">토픽 <span class="mqtt-sort-indicator"><span class="mqtt-sort-arrow mqtt-sort-arrow-up">▲</span><span class="mqtt-sort-arrow mqtt-sort-arrow-down">▼</span></span></th>',
