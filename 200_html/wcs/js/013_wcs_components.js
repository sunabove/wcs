...
const WCS_PAGE_ZOOM_FALLBACK_HTML = [
    ...
    '    <button type="button" id="page-zoom-decrease" class="btn btn-sm btn-outline-secondary" aria-label="화면 축소" title="화면 축소">',
    '        <i class="bi bi-dash-lg"></i>',
    '    </button>',
    '    <span id="page-zoom-value" class="text-white small text-center mx-1" style="min-width: 3.2em;">100%</span>',
    '    <button type="button" id="page-zoom-increase" class="btn btn-sm btn-outline-secondary" aria-label="화면 확대" title="화면 확대">',
